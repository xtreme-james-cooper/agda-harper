...
evaluate (App (Rec e0 es e) e2) | InL ()
evaluate (App (Abs e1)      e2) | InL AbsVal     with evaluate e2
evaluate (App (Abs e1) e2)      | InL AbsVal     | InL x          = InR (subst FZ e1 e2 , EvalApp3 x)
evaluate (App (Abs e1) e2)      | InL AbsVal     | InR (e2' , ev) = InR (App (Abs e1) e2' , EvalApp2 ev)
