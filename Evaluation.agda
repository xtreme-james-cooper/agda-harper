...
data eval {n tn : nat} {gam : vect (type tn) n} : {t : type tn} {b : bool} -> lam gam t False -> lam gam t b -> Set
...
evaluate : {t : type Zero} (e : lam [] t False) -> bool * (λ b -> lam [] t b * eval e)
