...
tsubst tv v (Tuple ts)   = {!!}
tsubst tv v (Variant ts) = {!!}
...
tincrSwap (Tuple ts)   x y gt = {!!}
tincrSwap (Variant ts) x y gt = {!!}
...
tsubstIncr t1 (Tuple ts)   x      y gt = {!!}
tsubstIncr t1 (Variant ts) x      y gt = {!!}
...
tincrSubst t1 (Tuple ts)   x y lt = {!!}
tincrSubst t1 (Variant ts) x y lt = {!!}
...
tsubstIncrRefl (Tuple ts)   t2 x = {!!}
tsubstIncrRefl (Variant ts) t2 x = {!!}
...
tsubstSwap (Tuple ts)          t2 t3 x y gt = {!!}
tsubstSwap (Variant ts)        t2 t3 x y gt = {!!}
...
tsubstIncrCollapse {tn}     x      (Tuple ts)      t2 = {!!}
tsubstIncrCollapse {tn}     x      (Variant ts)    t2 = {!!}
